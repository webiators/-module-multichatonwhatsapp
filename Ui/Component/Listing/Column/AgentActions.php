...
class AgentActions extends \Magento\Ui\Component\Listing\Columns\Column
{

    const URL_EDIT_PATH = 'multichatonwhatsapp/agent/edit';
    const URL_DELETE_PATH = 'multichatonwhatsapp/agent/delete';
